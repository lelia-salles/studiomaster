...
StudioMaster is an easy to use application for streaming high-quality,
...
Install the software by running 'StudioMaster Installer' executable. It will 
allow you to install the standalone application and the VST2, VST3, and AAX
 plugins at your discretion.

When you first launch StudioMaster, if Windows Gatekeeper prompts you
